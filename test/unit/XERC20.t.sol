...
abstract contract Base is Test {
    ...
    function _deployXERC20() internal returns (XERC20 ret_xerc20) {
        XUltraLRT xerc20Impl = new XUltraLRT();
        bytes memory initData = abi.encodeCall(XUltraLRT.initialize, ("Test", "TST", _owner, _owner));
        TransparentUpgradeableProxy proxy =
            new TransparentUpgradeableProxy(address(xerc20Impl), address(this), initData);

        ret_xerc20 = XERC20(address(proxy));
    }
